...
import { getFileHandler, streamFileHandler, uploadFileHandler, handleCreateFolder, markAndDeleteUnsafeFileController} from "./controller/files.controller";
...
function routes(app: Express){
    ...
    app.post('/api/file/mark-unsafe', verifyAccessToken, markAndDeleteUnsafeFileController )
}
